sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("randomizer/ui/ui/app", ".html");
	...
	return Opa5.extend("randomizer.ui.ui.test.integration.arramgements.Arrangement", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			return this.waitFor({
				success : function() {
					oOptions.hash = "/EmergingTechnologies/" + encodeURIComponent(sObjectId);
