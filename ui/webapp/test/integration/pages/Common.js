sap.ui.define([
	...
	return Opa5.extend("randomizer.ui.ui.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["randomizer/ui/ui/localService/mockserver"], function (mockserver) {
