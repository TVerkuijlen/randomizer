sap.ui.define([
	...
	"randomizer/ui/ui/test/integration/pages/Common",
	"randomizer/ui/ui/test/integration/pages/shareOptions"
		...
		onTheWorklistPage : {
					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success : function (oTableItem) {
							...
							this.getContext().currentItem = {
								...
								name: oBindingContext.getProperty("desciption")
							};
						}
					}));
				},
			...
			assertions: jQuery.extend({
				...
				theTableShouldHaveAllEntries : function () {
					...
					// retrieve all EmergingTechnologies to be able to check for the total amount
					this.waitFor(this.createAWaitForAnEntitySet({
						entitySet: "EmergingTechnologies",
